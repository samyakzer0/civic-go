...
const statusTemplates: NotificationTemplates = {
  ...
  'In Review': {
    ...
    message: (report: ReportData) => `Your report "${report.title}" is now being reviewed by our team.`,
    type: 'info'
  },
  'Forwarded': {
    title: 'Report Forwarded',
    message: (report: ReportData) => `Your report "${report.title}" has been forwarded to the ${report.category} department for action.`,
    type: 'info'
  },
  'Resolved': {
    title: 'Report Resolved',
    message: (report: ReportData) => `Great news! Your report "${report.title}" has been successfully resolved.`,
    type: 'success'
  },
  'Rejected': {
